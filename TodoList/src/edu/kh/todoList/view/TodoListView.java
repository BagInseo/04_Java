...
public class TodoListView {
	...
	private void todoAdd() throws IOException {
		...
		System.out.println("세부 작성 (입력 종료 시 !wq작성 후 엔터)");
		System.out.println("-----------------------------------------------");
	...
	private void todoUpdate() throws NumberFormatException, IOException {
		...
		System.out.println("수정할 세부 작성 (입력 종료 시 !wq작성 후 엔터)");
		System.out.println("-----------------------------------------------");
		StringBuilder sb=new StringBuilder();
	...
	private void todoDelete() throws NumberFormatException, IOException {
		...
		else System.out.printf("[%s]가 삭제 되었습니다.",title);
	...
	private int selectMenu() throws NumberFormatException, IOException {
		...
		int input = Integer.parseInt(br.readLine()); //br.readLine은 원래 String -> int로 형변환
		System.out.println();
