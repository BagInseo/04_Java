...
public class FileService {
	 ...
	 *     
	 *  -  Java 언어의 특징 : 플랫폼(OS)에 독립적 => OS 관계 없이 똑같이 코드 작성이 가능
	 ...
	 *  [Mac] : Linux
	 *  
	 *  2) 상대 경로 : 현재 위치를 기준으로 목표까지의 경로르 표기하는 방법
	 *  
	 *  현 건물로 부터 왼쪽으로 5번째 건물
	 *  문 열고 나가고 직전 후 우회전
	 *  
	 *  
	 *  
	...
	public void method1()
	{
		...
		//->처음 : 존재하니 않는 폴더를 관리하는 File 객체 생성
		System.out.println("존재여부 확인: " + directory.exists());
	...
	public void method3() {
		...
		//지정된 디렉토리에 있는 모든 파일/디렉토리를 File[] g형태로 얻어오기
